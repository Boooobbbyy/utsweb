        ...
        <div class="container">
            <div class="row">
                <div class="col">
                    ...
                    <a href="/pages/create" class="btn btn-primary mb-3">Tambah Buku</a>
                    <table class="table">
                        <thead>
                            <tr>
                                <th scope="col">No</th>
                        ...
                        <tbody>
                            ...
                            <?php foreach ($buku as $b) : ?>
                                <tr>
                                    ...
                                    <td><?= $b['penerbit']; ?></td>
                                    <td>
                                        <a href="/pages/edit/<?= $b['slug']; ?>" class="btn btn-success"><i class="fas fa-edit"></i></a>
                                        <form action="/pages/<?= $b['id']; ?> " method="post" class="d-inline">
                                            <?= csrf_field(); ?>
